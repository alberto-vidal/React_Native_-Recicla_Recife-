...
const Page_01_01_Vidro = ({navigation}) => {
    return (
      <>
        ...
        <View style={styles.container}>
            ...
            <Text>
                Copo; Frasco de remédio; Jarras; Garrafa; Vidro colorido.{"\n"}
            </Text>
            <Text style={{textDecorationLine: 'underline'}}>
                Vidros que{" "}
            ...
            <Text>
            Vidro de automóvel; Vidros de janelas; Pirex; Espelho; Tubo de TV; Lâmpada; Óculos; Cristal; Ampolas de medicamentos; Vidros temperados planos ou de utensílios domésticos.{"\n"}
            </Text>
  ...
  export default Page_01_01_Vidro
