...
const Page_01_01_Papel = ({navigation}) => {
    return (
      <>
        ...
        <View style={styles.container}>
            ...
            <Text>
            Jornal; Papel de computador; Saco de papel; Papel de escritório; Cadernos.{"\n"}
            </Text>
            <Text style={{textDecorationLine: 'underline'}}>
                Papéis que {" "}
            ...
            <Text>
                Papel engordurado; Carbono; Celofane; Papel plastificado; Papel parafinado (especiais).{"\n"}
            </Text>
  ...
  export default Page_01_01_Papel
