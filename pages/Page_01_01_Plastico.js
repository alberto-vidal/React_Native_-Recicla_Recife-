...
const Page_01_01_Plastico = ({navigation}) => {
    return (
      <>
        ...
        <View style={styles.container}>
            ...
            <Text>
                Embalagem de alimentos; Embalagem de produtos de beleza; Embalagem de produtos de limpeza; Tampas; Brinquedos; Peças plásticas; Canetas esferográficas; Escovas de dentes; Baldes; Artigos de cozinha.{"\n"}
            </Text>
            <Text style={{textDecorationLine: 'underline'}}>
                Plásticos que{" "}
            ...
            <Text>
                Celofane; Embalagem a vácuo; Fraldas descartáveis; Adesivos; Embalagem engordurada; Siliconizados.{"\n"}
            </Text>
  ...
  export default Page_01_01_Plastico
